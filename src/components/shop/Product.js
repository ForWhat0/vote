...
export default function Product(props) {
  ...
  const filter_data = org_form.filter(
    element => element.name.toLowerCase().indexOf(search_low) !== -1
  );
    ...
    if (props.is_start == false) {
      return (
        <div className={s.start}>
          ...
          <li>
            {" "}
            Мета збору даних - глибокий аналіз стану цифрової трансформації та
      ...
      return (
        <div style={{ width: "100%", textAlign: "center" }}>
          ...
          {props.number == 0 ? (
            <div>
              <h1>Назва вашого підприємства</h1>
              <li>
                <input
                  className={s.inp}
                  type="login"
              ...
              <button
                ...
                onClick={
                  one_answer == ""
                    ? () => {
                        alert("введіть назву вашого підприємства");
                      }
                    : () => {
                        props.one(one_answer);
                      }
                }
              >
                NEXT
            ...
            <div>
              <h1>Кількість працівників у вашій організації</h1>
              <div className={s.dropdown}>
                ...
                <div className={s.global}>
                  ...
                  >
                    <li
                      value="мікро підприємство"
                      onClick={event => handleSecond(event)}
                    >
                      від 1 до 10
                    </li>
                    <li
                      value="мале підприємство"
                      onClick={event => handleSecond(event)}
                    >
                      від 10 до 50
                    </li>
                    <li
                      value="середнє підприємство "
                      onClick={event => handleSecond(event)}
                    >
                      від 50 до 250
                    </li>
                    <li
                      value="велике підприємство "
                      onClick={event => handleSecond(event)}
                    >
                      більше 250
                    </li>
              ...
              <button
                ...
                onClick={
                  answer_second == ""
                    ? () => {
                        alert("оберіть свій варіант");
                      }
                    : () => {
                        down();
                        props.second(second_answer);
                      }
                }
              >
                NEXT
            ...
            <div className={s.option}>
              <h1>
                Оберіть галузь господарювання за видами економічної діяльності
                (КВЕД)
              </h1>
              {cwed.map(item => (
                <ul>
                  <li>
                    <input
                      ...
                      name={item.name}
                    />
                    <label value={answer_first} for={item.name}>
                      {item.name}
                    </label>
                  </li>
                </ul>
              ...
              <button
                className={s.butt}
                onClick={
                  answer_first.length == 0
                    ? () => {
                        alert("оберіть свій варіант");
                      }
                    : () => {
                        props.nextItem_for_first(answer_first);
                      }
                }
              >
                NEXT
            ...
            <div>
              <h1>Якою є організаційна форма вашого підприємства?</h1>
              <div className={s.dropdown}>
                <div className={s.global}>
                  <div className={s.text}>
                    <input
                ...
                <div className={s.global}>
                  ...
                  >
                    {filter_data.map(item => (
                      <li
                        value={item.name}
                        onClick={event => handleSecondChange(event)}
                      >
                        {item.name}
                      </li>
                    ))}
              ...
              <button
                ...
                onClick={
                  answer_second == null
                    ...
                    : () => {
                        props.nextItem_for_second(answer_second);
                      }
                }
              >
                NEXT
