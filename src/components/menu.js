      ...
      <div className={s.global}>
              ...
              return product.islogined === "false" ? (
                <React.Fragment>
                  <div
                    ...
                    className={s.profil_avatar}
                  ></div>
                  <div
                    onClick={() => product.openModal()}
                ...
                <React.Fragment>
                  ...
                  <div
                    ...
                    className={s.profil_avatar}
                  ></div>
                  <div className={s.profil_text}>
                    <Link to="/cabinet">{product.user[0].login}</Link>
                  </div>
                </React.Fragment>
              );
            }}
        ...
        <nav className={s.nav}>
          <ul>
            ...
            <li>
              <NavLink exact to="/Order" activeClassName={s.active}>
                {" "}
                Пройти опитування{" "}
              </NavLink>
            </li>
            ...
            <li>
              <NavLink exact to="/Contact" activeClassName={s.active}>
                {" "}
                Про нас{" "}
              </NavLink>
            </li>
