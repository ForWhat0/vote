...
/>
                    ...
                    <button className={s.detail_button}  onClick={()=>value.update_gallery(id,this.state.name,this.state.price,this.state.tittle) }>
                             UPDATE
                          </button>
                          <Link to="/ADMIN_3004_PAINT/Gallery">
                          <button className={s.detail_button} onClick={()=>value.delete_gallery(id) }>
                             DELETE
                          </button>
                    </Link>
