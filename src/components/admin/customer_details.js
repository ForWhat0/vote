...
class Customer_details extends React.Component{
    ...
    return(
        ...
        {value=>{
            const {id,img,email,name,size,total,name_of_product,country,city,address,tittle,count}=value.details;
            this.imagestore=()=> {
                this.setState({
                    email: email,
                    name:name,
...
<input
   className={s.detail_button}
    type="text" value={this.state.tittle}
...
/>
                      ...
                      <input
   className={s.detail_button}
    type="text" value={this.state.name_of_product}
...
<input
   className={s.detail_button}
    type="text" value={this.state.count}
    
    onChange={e => this.change_count(e.target.value)}
/>
<input
   className={s.detail_button}
    type="text" value={this.state.size}
...
/>
                    ...
                    <button className={s.detail_button}  onClick={()=>value.update_customer(
                        id,this.state.name,this.state.price,this.state.tittle,this.state.email,
                        this.state.name_of_product,this.state.size,this.state.country,
                        this.state.city,this.state.address,this.state.count) }>
                             UPDATE
                          </button>
                          <Link to="/ADMIN_3004_PAINT/Customers">
                          <button className={s.detail_button} onClick={()=>value.delete_customer(id) }>
                             DELETE
                          </button>
                    </Link>
