...
/>
                    ...
                    <button className={s.detail_button} onClick={()=>value.update_order(id,this.state.price,this.state.size) }>
                             UPDATE
                          </button>
                          <Link to="/ADMIN_3004_PAINT/Orders">
                          <button className={s.detail_button} onClick={()=>value.delete_order(id) }>
                             DELETE
                          </button>
                    </Link>
