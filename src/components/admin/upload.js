  ...
  render() {
    return (
      <div className={s.form}>
        ...
        <select
          indecator="indecator"
          value={this.state.indecator}
          onChange={e => this.change_indecator(e)}
        >
        ...
        <input
          name="weight"
          placeholder="вага питання"
          value={this.state.weight}
          onChange={e => this.change_weight(e)}
        />
        {this.state.new.map((item, index) => {
          return (
            <div key={index}>
              ...
              <input
                onChange={e => this.handleChange_weight(e, index)}
