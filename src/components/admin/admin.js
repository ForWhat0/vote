 ...
 if(login==='1'&& password==='2'){
  ...
  render(){
    ...
    return( 
     ...
     {admin?(
       <React.Fragment>
     <div className={s.menu}> <Route path='/ADMIN_3004_PAINT'  component={Admin_menu}/> </div>
    <div className={s.content}>
    <Route path='/ADMIN_3004_PAINT/Customer_details'  component={Customer_details}/> 
    <Route path='/ADMIN_3004_PAINT/Customers'  component={Customers}/> 
    <Route path='/ADMIN_3004_PAINT/Product_details'  component={Product_details}/> 
    <Route path='/ADMIN_3004_PAINT/Order_details'  component={Order_details}/> 
